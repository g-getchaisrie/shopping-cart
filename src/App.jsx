...
export default function App() {
  ...
  const categories = [
    { id: 1, name: 'ตุ๊กตาแมว 3 สี 25cm' },
    { id: 2, name: 'ตุ๊กตาแมวเบบี้ 50cm' },
    { id: 3, name: 'ตุ๊กตาแมวเหมียวนุ่มนิ่ม 70cm' },
    { id: 4, name: 'ตุ๊กตาแมวจักรพรรดิ 35-90cm' },
    { id: 5, name: 'ตุ๊กตาแมวอ้วนตัวใหญ่ 60cm' },
    { id: 6, name: 'ตุ๊กตาแมวอ้วนกลม 45cm' },
    { id: 7, name: 'ตุ๊กตาแมวเหมียวอ้วน 60-100cm' }
  ];
  ...
  const total = subtotal - discount + 100; // Add shipping
    ...
    return (
      <div className="container mx-auto px-4">
        ...
        <p></p>
          <h1 className="text-5xl font-bold text-pink-600">ร้านตุ๊กตาเลิฟลี่ ขายตุ๊กตาแมว ตุ๊กตาแมวตัวใหญ่</h1>
        </header>
